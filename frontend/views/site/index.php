		...
		<div id = "legend-bar-container">
			<div id ='mapLegend' class='col-xs-12'>
				...
				<?php $form = ActiveForm::begin(['id' => 'mapLayerForm','action'=> ['/system-rest/store-settings']]); ?>
						<div class='col-xs-6'>
							<?= $form->field($layersModel, 'fireSizeList')->checkboxList (Yii::$app->systemData->fireSizes, $options = ['class'=>'legendOptions','name'=>'fireSize'])?>
						</div>
						<div class='col-xs-6'>
							<?= $form->field($layersModel, 'fireStatusList')->checkboxList (Yii::$app->systemData->fireClasses, $options = ['class'=>'legendOptions','name'=>'fireClass'])?>
						</div>
						<div class='col-xs-6'>
							<?= $form->field($layersModel, 'addtlLayers')->checkboxList (Yii::$app->systemData->addlMapLayers, $options = ['class'=>'legendOptions','name'=>'addtlLayers'])?>
						</div>
