 ...
 * @since 2.0
 */
class MyLocationsWidget extends BaseListView
{
    ...
    */
    public function run()
    {
        ...
        if(!empty($this->dataProvider->getModels())){
            ...
            $view->registerJs("jQuery('#$id').on('click','tbody tr',function(e){
                wfnm.goToUserMyLocation(jQuery(this));
            });");
        }
        ArrayHelper::remove($this->options,'id');
        parent::run();
    ...
    public function renderItems()
    {
        ...
        //Render Edit Butns
        $html[] = $this->renderEditSection();
        $html[] = Html::tag('table', implode("\n", $content), $this->tableOptions);
        return implode(PHP_EOL, $html);
    }

    protected function renderEditSection(){
        // return 'asdf';
    }
    ...
    public function renderTableBody()
    {
        ...
        if (empty($rows)) {
            ...
            return "<tbody class='myLocations-table'>\n" . implode("\n", $rows) . "\n</tbody>";
        }
    }
