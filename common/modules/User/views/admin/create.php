        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="alert alert-info">
                    ...
                    <?= Yii::t('user', 'A Username & Password will be generated automatically if not provided. First & Last Name are Required') ?>.
                </div>
                ...
                <?= $this->render('_usercreate', ['form' => $form, 'user' => $user,'listData' => $listData,]) ?>
