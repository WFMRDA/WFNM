...
You should override view file `@ptech/user/views/admin/_user.php` as described in [special guide](overriding-views.md)
...
```php
class RegistrationForm extends \common\modules\User\models\RegistrationForm
{
    /**
     * @var string
     */
