...
(function( $ ){
  ...
  $.fn.birthdaypicker = function( options ) {
    ...
    return this.each(function() {
      ...
      /*if(settings['fieldClass'] != null){
        var $fieldset = $("<fieldset class='birthday-picker'></fieldset>"),
          $year = $("<select class='birth-year " +  settings['fieldClass'] + "' name='birth[year]'></select>"),
          $month = $("<select class='birth-month " +  settings['fieldClass'] + "'  name='birth[month]'></select>"),
          $day = $("<select class='birth-day " +  settings['fieldClass'] + "'  name='birth[day]'></select>");
      }else{
        var $fieldset = $("<fieldset class='birthday-picker'></fieldset>"),
      ...
      /*      $year = $("#birthday-year").replaceWith("<select class='birth-year' name='birth[year]'></select>");
      $month = $("#birthday-month").replaceWith("<select class='birth-month' name='birth[month]'></select>");
      $day = $("#birthday-day").replaceWith("<select class='birth-day' name='birth[day]'></select>");
      */
...
/*
      ...
      $($year).wrap( "<div class='small-12 medium-4 columns'></div>" );
      $($month).wrap( "<div class='small-12 medium-4 columns'></div>" );
      $($day).wrap( "<div class='small-12 medium-4 columns'></div>" );
